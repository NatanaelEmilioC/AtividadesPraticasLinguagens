...
--(a) replace :: Eq a ) a -> a -> [a] -> [a] que dado o primeiro e segundo par^ametro, troca onde tiver o valor do primeiro par^ametro pelo o valor do segundo par^ametro.
